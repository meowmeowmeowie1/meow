        ...
        internal static void Draw(Preset preset)
        {
            switch (preset)
            {
                ...
                case Preset.SGE_ST_Advanced_DPS:
                    DrawHorizontalRadioButton(SGE_ST_Adv_DPS_Advanced,
                ...
                case Preset.SGE_ST_Adv_DPS_EDosis:
                    DrawSliderInt(0, 100, SGE_ST_Adv_DPS_EukrasianDosisBossOption,
                        Generics.BossOnlyHpPercent);

                    DrawSliderInt(0, 100, SGE_ST_Adv_DPS_EukrasianDosisBossAddsOption,
                        Generics.BossEncounterNonBossHpPercent);

                    DrawSliderInt(0, 100, SGE_ST_Adv_DPS_EukrasianDosisTrashOption,
                        Generics.NonBossHpPercent);

                    ImGui.Indent();
                    DrawRoundedSliderFloat(0, 4,
                        SGE_ST_Adv_DPS_EukrasianDosisUptime_Threshold,
                ...
                case Preset.SGE_ST_Adv_DPS_Lucid:
                    DrawSliderInt(4000, 9500, SGE_ST_Adv_DPS_Lucid,
                        Generics.LucidMP, 150, Hundreds);
                    break;

                case Preset.SGE_ST_Adv_DPS_Rhizo:
                    DrawSliderInt(1, 3, SGE_ST_Adv_DPS_Rhizo,
                ...
                case Preset.SGE_ST_Adv_DPS_Movement:
                    DrawHorizontalMultiChoice(SGE_ST_Adv_DPS_Movement, Toxikon.ActionName(),
                        FormatAndCache(Generics.Use0When1ChargesAreAvailable, Toxikon.ActionName(), Traits.Addersting.TraitName()), 3, 0);

                    DrawPriorityInput(SGE_ST_Adv_DPS_Movement_Priority, 3, 0, FormatAndCache(Generics.Action_Priority, Toxikon.ActionName()));

                    DrawHorizontalMultiChoice(SGE_ST_Adv_DPS_Movement, Dyskrasia.ActionName(),
                        FormatAndCache(Generics.Use0WhenInRangeOfEnemy, Dyskrasia.ActionName()), 3, 1);

                    DrawPriorityInput(SGE_ST_Adv_DPS_Movement_Priority, 3, 1, FormatAndCache(Generics.Action_Priority, Dyskrasia.ActionName()));

                    DrawHorizontalMultiChoice(SGE_ST_Adv_DPS_Movement, Eukrasia.ActionName(),
                        FormatAndCache(Generics.Use0, Eukrasia.ActionName()), 3, 2);

                    DrawPriorityInput(SGE_ST_Adv_DPS_Movement_Priority, 3, 2, FormatAndCache(Generics.Action_Priority, Eukrasia.ActionName()));
                    break;

                case Preset.SGE_AoE_Adv_DPS_Lucid:
                    DrawSliderInt(4000, 9500, SGE_AoE_Adv_DPS_Lucid,
                        Generics.LucidMP, 150, Hundreds);
                    break;

                case Preset.SGE_AoE_Adv_DPS_Pneuma:
                    DrawHorizontalRadioButton(SGE_AoE_Adv_DPS_PneumaBossOption,
                ...
                case Preset.SGE_AoE_Adv_DPS_Rhizo:
                    DrawSliderInt(1, 3, SGE_AoE_Adv_DPS_Rhizo,
                        FormatAndCache(Generics.Action_Threshold, Traits.Addersgall.TraitName()));
                    break;

                case Preset.SGE_AoE_Adv_DPS_AddersgallProtect:
                    DrawSliderInt(1, 3, SGE_AoE_Adv_DPS_AddersgallProtect,
                        FormatAndCache(Generics.Action_Threshold, Traits.Addersgall.TraitName()));
                    break;
                ...
                case Preset.SGE_ST_Adv_Heal_Esuna:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_Esuna,
                        Generics.StopFriendlyHpPercentZero);
                    break;

                case Preset.SGE_ST_Adv_Heal_Lucid:
                    DrawSliderInt(4000, 9500, SGE_ST_Adv_Heal_LucidOption,
                        Generics.LucidMP, 150, Hundreds);
                    break;

                case Preset.SGE_ST_Adv_Heal_Soteria:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_Soteria, Generics.StopFriendlyHpPercent100);
                    DrawPriorityInput(SGE_ST_Heals_Priority, 12, 0, FormatAndCache(Generics.Action_Priority, Soteria.ActionName()));
                    break;

                case Preset.SGE_ST_Adv_Heal_Zoe:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_Zoe,
                ...
                case Preset.SGE_ST_Adv_Heal_Pepsis:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_Pepsis,
                        Generics.StopFriendlyHpPercent100);

                    DrawPriorityInput(SGE_ST_Heals_Priority, 12, 2, FormatAndCache(Generics.Action_Priority, Pepsis.ActionName()));
                    break;

                case Preset.SGE_ST_Adv_Heal_Taurochole:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_Taurochole,
                        Generics.StopFriendlyHpPercent100);

                    DrawAdditionalBoolChoice(SGE_ST_Adv_Heal_Taurochole_TankOnly,
                        Generics.TanksOnly,
                ...
                case Preset.SGE_ST_Adv_Heal_Haima:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_Haima,
                        Generics.StopFriendlyHpPercent100);

                    DrawAdditionalBoolChoice(SGE_ST_Adv_Heal_HaimaBossOption,
                        Generics.NotInBossEncounters,
                        Generics.WillNotUseInBossEncounters);

                    DrawAdditionalBoolChoice(SGE_ST_Adv_Heal_Haima_TankOnly,
                        Generics.TanksOnly,
                        Generics.WillOnlyUseOnTanks);
                ...
                case Preset.SGE_ST_Adv_Heal_Krasis:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_Krasis,
                        Generics.StopFriendlyHpPercent100);

                    DrawAdditionalBoolChoice(SGE_ST_Adv_Heal_KrasisBossOption,
                        Generics.NotInBossEncounters,
                        Generics.WillNotUseInBossEncounters);

                    DrawAdditionalBoolChoice(SGE_ST_Adv_Heal_Krasis_TankOnly,
                        Generics.TanksOnly,
                        Generics.WillOnlyUseOnTanks);
                ...
                case Preset.SGE_ST_Adv_Heal_Druochole:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_Druochole,
                        Generics.StopFriendlyHpPercent100);

                    DrawPriorityInput(SGE_ST_Heals_Priority, 12, 6, FormatAndCache(Generics.Action_Priority, Druochole.ActionName()));
                    break;

                case Preset.SGE_ST_Adv_Heal_EDiagnosis:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_EDiagnosisHP,
                        Generics.StopFriendlyHpPercent100);

                    DrawHorizontalMultiChoice(SGE_ST_Adv_Heal_EDiagnosisOpts,
                ...
                case Preset.SGE_ST_Adv_Heal_Kerachole:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_KeracholeHP,
                        Generics.StopFriendlyHpPercent100);

                    DrawAdditionalBoolChoice(SGE_ST_Adv_Heal_KeracholeBossOption,
                        Generics.NotInBossEncounters,
                        Generics.WillNotUseInBossEncounters);
                ...
                case Preset.SGE_ST_Adv_Heal_Physis:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_PhysisHP,
                        Generics.StopFriendlyHpPercent100);

                    DrawAdditionalBoolChoice(SGE_ST_Adv_Heal_PhysisBossOption,
                        Generics.NotInBossEncounters,
                        Generics.WillNotUseInBossEncounters);
                ...
                case Preset.SGE_ST_Adv_Heal_Panhaima:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_PanhaimaHP,
                        Generics.StopFriendlyHpPercent100);

                    DrawAdditionalBoolChoice(SGE_ST_Adv_Heal_PanhaimaBossOption,
                        Generics.NotInBossEncounters,
                        Generics.WillNotUseInBossEncounters);
                ...
                case Preset.SGE_ST_Adv_Heal_Holos:
                    DrawSliderInt(0, 100, SGE_ST_Adv_Heal_HolosHP,
                        Generics.StopFriendlyHpPercent100);

                    DrawAdditionalBoolChoice(SGE_ST_Adv_Heal_HolosBossOption,
                ...
                case Preset.SGE_AoE_Adv_Heal_Lucid:
                    DrawSliderInt(4000, 9500, SGE_AoE_Adv_Heal_LucidOption,
                        Generics.LucidMP, 150, Hundreds);
                    break;

                case Preset.SGE_AoE_Adv_Heal_Kerachole:
                    DrawSliderInt(0, 100, SGE_AoE_Adv_Heal_KeracholeOption,
                        Generics.StartUsingWhenBelowPartyAverageHPSetTo100ToDisableThisCheck);

                    DrawAdditionalBoolChoice(SGE_AoE_Adv_Heal_KeracholeTrait,
                ...
                case Preset.SGE_AoE_Adv_Heal_Ixochole:
                    DrawSliderInt(0, 100, SGE_AoE_Adv_Heal_IxocholeOption,
                        Generics.StartUsingWhenBelowPartyAverageHPSetTo100ToDisableThisCheck);

                    DrawPriorityInput(SGE_AoE_Heals_Priority, 9, 1, FormatAndCache(Generics.Action_Priority, Ixochole.ActionName()));
                    break;

                case Preset.SGE_AoE_Adv_Heal_Physis:
                    DrawSliderInt(0, 100, SGE_AoE_Adv_Heal_PhysisOption,
                        Generics.StartUsingWhenBelowPartyAverageHPSetTo100ToDisableThisCheck);

                    DrawPriorityInput(SGE_AoE_Heals_Priority, 9, 2, FormatAndCache(Generics.Action_Priority, Physis.ActionName()));
                    break;

                case Preset.SGE_AoE_Adv_Heal_Holos:
                    DrawSliderInt(0, 100, SGE_AoE_Adv_Heal_HolosOption,
                        Generics.StartUsingWhenBelowPartyAverageHPSetTo100ToDisableThisCheck);

                    DrawPriorityInput(SGE_AoE_Heals_Priority, 9, 3, FormatAndCache(Generics.Action_Priority, Holos.ActionName()));
                    break;

                case Preset.SGE_AoE_Adv_Heal_Panhaima:
                    DrawSliderInt(0, 100, SGE_AoE_Adv_Heal_PanhaimaOption,
                        Generics.StartUsingWhenBelowPartyAverageHPSetTo100ToDisableThisCheck);

                    DrawHorizontalMultiChoice(SGE_ST_Adv_Heal_PanhaimaOpts,
                ...
                case Preset.SGE_AoE_Adv_Heal_Pepsis:
                    DrawSliderInt(0, 100, SGE_AoE_Adv_Heal_PepsisOption,
                        Generics.StartUsingWhenBelowPartyAverageHPSetTo100ToDisableThisCheck);

                    DrawPriorityInput(SGE_AoE_Heals_Priority, 9, 5, FormatAndCache(Generics.Action_Priority, Pepsis.ActionName()));
                    break;

                case Preset.SGE_AoE_Adv_Heal_Philosophia:
                    DrawSliderInt(0, 100, SGE_AoE_Adv_Heal_PhilosophiaOption,
                        Generics.StartUsingWhenBelowPartyAverageHPSetTo100ToDisableThisCheck);

                    DrawPriorityInput(SGE_AoE_Heals_Priority, 9, 6, FormatAndCache(Generics.Action_Priority, Philosophia.ActionName()));
                    break;

                case Preset.SGE_AoE_Adv_Heal_Zoe:
                    DrawSliderInt(0, 100, SGE_AoE_Adv_Heal_ZoeOption,
                        Generics.StartUsingWhenBelowPartyAverageHPSetTo100ToDisableThisCheck);

                    DrawPriorityInput(SGE_AoE_Heals_Priority, 9, 7, FormatAndCache(Generics.Action_Priority, Zoe.ActionName()));
                    break;

                case Preset.SGE_AoE_Adv_Heal_EPrognosis:
                    DrawSliderInt(0, 100, SGE_AoE_Adv_Heal_EPrognosisOption,
